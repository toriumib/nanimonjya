...
class Sfx {
  ...
  /// 🎴 カードを獲得したときの音。
  ///
  /// 正解音（correct.wav）は「合ってた」の合図で、そのあと実際に
  /// カードが手に入る瞬間には何も鳴っていなかった。
  /// 取れた実感が薄いので、獲得だけの専用音を鳴らす。
  ///
  /// 音源は外部素材ではなく、このプロジェクトで合成した波形
  /// （長三和音の分散＋きらめき）。権利関係の制約はない。
  Future<void> get() => _play('get.wav', volume: 0.9);
