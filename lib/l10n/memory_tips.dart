...
const List<MemoryTipPage> kMemoryTipPages = [
  ...
  MemoryTipPage(
    ...
    bodyJa: '「見て覚える」より「思い出す」ほうが記憶に残る——これは記憶研究でくり返し確かめられてきた'
        ...
        '🧠 「名刺覚え」は、出会って→時間をおいて→思い出す、というこの流れそのもの。\n\n'
  ...
  MemoryTipPage(
    ...
    bodyJa: '同じ10分を使うなら、どう配るのがいいのでしょう。\n\n'
        ...
        '・名刺覚えの「時間をおく → 思い出す」の間は、わざと空けてあります\n'
        '・まちがえた人は**日をあらためて**また出てきます。その場でもう1周するより、'
        '間隔をあけて思い出すほうが定着に効くとされています\n\n'
        '🔬 出典（PubMedより）\n'
