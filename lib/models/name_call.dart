...
class NameCallGame {
  /// 登場人数のデフォルト。
  ///
  /// **12人**（× [defaultCopiesPerPerson] 5枚 ＝ 山札60枚）。
  /// 定番のカードゲームと同じ構成にしたい、というオーナーの指定。
  ///
  /// ⚠️ **完走率とのトレードオフを承知のうえで戻した値。**
  ///    もともと12人だったが、計測で「ゲームを始めた54人のうち
  ///    20人しか終わりまで到達しない（完走37%）」と分かり、
  ///    6人→4人と下げた経緯がある。60枚はその頃の7.5倍。
  ///    2026-08 時点の完走率は39%で、目標は60%。
  ///    **下げたくなったらここだけ直せばよい**（8〜10人が中間案）。
  ///    判断は Analytics の game_start / game_end の比で行うこと。
  ///
  /// 短く遊びたい人は、ホームのスライダーで4人まで下げられる。
