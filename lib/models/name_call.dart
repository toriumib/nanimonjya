...
class NameCallGame {
  ...
  /// 1人あたりの札の枚数の既定値。
  ///
  /// **2枚**にしてある。2枚なら「初登場で名前をつける → もう一度出たら答える」
  /// の1往復で終わる。同じ顔は2回しか出ないので、ゲームとして単純で分かりやすい。
  ///
  /// ⚠️ 2026-08 に「同じ人が何回も出てくる＝ゲームとしてだめ」と報告され、
  ///     5枚→2枚に引き下げた。以前は5枚＝同じ顔に4回出会う作りで、
  ///     間隔反復の理屈では正しいが、プレイ感が「同じ人ばかり」になっていた。
  ///     枚数を増やしたい人（間隔反復重視）はホームのスライダーで上げられる。
